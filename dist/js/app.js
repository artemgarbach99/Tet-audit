  ...
  (() => {
    ...
    const F = {
      ...
      slideToClickedSlide: function () {
        ...
        if (t.loop) {
          ...
          (a = parseInt(S(e.clickedSlide).attr("data-swiper-slide-index"), 10)),
            t.centeredSlides
      ...
      loopCreate: function () {
        ...
        r.each((t, i) => {
          ...
          i < e.loopedSlides && o.push(t),
            i < r.length && i >= r.length - e.loopedSlides && s.push(t),
            n.attr("data-swiper-slide-index", i);
        });
        for (let e = 0; e < o.length; e += 1)
          a.append(S(o[e].cloneNode(!0)).addClass(i.slideDuplicateClass));
        for (let e = s.length - 1; e >= 0; e -= 1)
          a.prepend(S(s[e].cloneNode(!0)).addClass(i.slideDuplicateClass));
      },
      loopFix: function () {
        const e = this;
      ...
      t({
        ...
        i("click", (t, i) => {
          const { $nextEl: a, $prevEl: r } = e.navigation,
            s = i.target;
          if (e.params.navigation.hideOnClick && !S(s).is(r) && !S(s).is(a)) {
            if (
              e.pagination &&
              e.params.pagination &&
    ...
    window.addEventListener("load", function (e) {
      ce(),
        ...
        document.querySelector(".who__slider") &&
          new oe(".who__slider", {
            observer: !0,
            observeParents: !0,
            slidesPerView: "auto",
        ...
        document.querySelector(".advantage__slider") &&
          new oe(".advantage__slider", {
            observer: !0,
            observeParents: !0,
            slidesPerView: "auto",
            spaceBetween: 22,
        ...
        document.querySelector(".publication__slider") &&
          new oe(".publication__slider", {
            modules: [le],
            observer: !0,
            observeParents: !0,
            slidesPerView: "auto",
    ...
    setTimeout(() => {
      ...
      (ue.prototype.moveTo = function (e, t, i) {
      ...
      (ue.prototype.moveBack = function (e, t, i) {
          ...
          function o(e) {
            ...
            if (i.closest("[data-spoller]")) {
              ...
              r.querySelectorAll("._slide").length ||
                (s && !a.classList.contains("_spoller-active") && c(r),
